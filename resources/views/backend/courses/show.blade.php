                                    ...
                                    <form class="forms-sample" action="" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="student_name"
                                                placeholder="Student Name" value="{{ $student->student_name }}" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="studentInputLevel">Student Level</label>
                                            <input type="text" class="form-control" name="student_level"
                                                value="{{ $student->student_level }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="studentInputAge">Age</label>
